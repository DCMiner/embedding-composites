...
class TestSmoke(unittest.TestCase):
    ...
    def test_smoke(self):
        file_path = os.path.join(example_dir, 'manual_embed_qubo_chimera.py')

        value = subprocess.check_output(["python", file_path, "4"])

        # Check the expected energy
        str1 = '{0: 0, 1: 0, 4: 0, 5: 0} 0.0'
        str2 = '{0: 0, 1: 1, 4: 0, 5: 1} 0.0'
        str3 = '{0: 1, 1: 1, 4: 0, 5: 1} 0.0'
        str4 = '{0: 1, 1: 1, 4: 1, 5: 1} 0.0'
        str5 = '{0: 1, 1: 0, 4: 1, 5: 0} 0.0'
        str6 = '{0: 0, 1: 0, 4: 1, 5: 0} 0.0'
